                ...
                <div className='home__container'>
                    <div className='home-hero__content'>
                        <div className='home-hero__left'>
                            <motion.div
                                className='home-hero__box '
                                initial={{ opacity: 0, y: 30 }}
                                animate={{ opacity: 1, y: 0 }}
                                transition={{ duration: 1, ease: "easeOut" }}
                            >
                                <h1 className='home-hero__title'>Знакомые миры, <span className='home-hero__span'>непредсказуемые</span> истории</h1>
                                <p className='home-hero__descr'>
                                    Стабильный мир встречает динамичное повествование. Исследуйте знакомые локации,
